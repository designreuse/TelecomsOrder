 ...
 * All rights reserved.
 */
package com.suypower.cloudx.support.encrypt;
...
public class DesEncrypter {
	...
	public static void main(String args[]){
		String serverIp = "172.17.126.140";
		String serverPort = "9108";
		String ens = encrypt(serverIp,"suypower");
		String serverPortEns = encrypt(serverPort,"suypower");
		System.out.println("serverIp 加密:"+ens);
		System.out.println("serverPort 加密:"+serverPortEns);
		String des = decrypt(ens,"suypower");
		String serverPortDes = decrypt(serverPortEns,"suypower");
		//System.out.println("ens:"+ens);
		System.out.println("serverIp 解密："+des);
		System.out.println("serverPort 解密："+serverPortDes);
	}
