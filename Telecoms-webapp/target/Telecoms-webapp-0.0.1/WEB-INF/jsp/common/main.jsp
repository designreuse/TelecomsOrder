    ...
    <div class="row content-tabs">
        ...
        <nav class="page-tabs">
            <div class="page-tabs-content">
                <a href="javascript:void(0);" class="active J_menuTab" data-id="iframe0">工作台</a>
            </div>
        </nav>
        <button class="roll-nav roll-right J_tabRight"><i class="fa fa-forward"></i>
        </button>
    </div>
    <div class="row tab-container" id="tabs-content">
        <iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                src="system/dashboard/show" frameborder="0" data-id="iframe0"
                seamless=""></iframe>
    </div>
