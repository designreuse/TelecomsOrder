...
jQuery.workflow = {
    completeTask: function (params) {
        layer.closeAll();
        if (params && (params.commandType == 'claim' || params.commandType == 'releaseTask')) {
            ...
            var data = $('#approveFrom form').serializeJSON();
            data.taskParams = params ? JSON.stringify(params) : null;
